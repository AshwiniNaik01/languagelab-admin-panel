...
export const initialInstitutes = [
  {
    _id: "col1",
    institute_name: "ABC Institute of Engineering",
    institute_code: "ABCCE",
  ...
  {
    _id: "col2",
    institute_name: "XYZ Institute of Technology",
    institute_code: "XYZIT",
...
export const initialActiveSessions = [
  {
    ...
    license_id: "lic1",
    institute_id: { _id: "col1", institute_name: "ABC Institute of Engineering" },
    token: "jwt_token_123...",
