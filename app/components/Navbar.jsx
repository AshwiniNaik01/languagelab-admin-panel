  ...
  return (
    <header className="h-20 bg-gradient-to-r from-[#FFF8F4]/95 to-[#FFF2EA]/95 backdrop-blur-md border-b border-orange-500/20 px-4 flex items-center justify-between z-10 shrink-0 shadow-lg shadow-orange-950/5">
      ...
      <div className="flex items-center ">
        ...
        <div className="border-r border-orange-500/20 pr-3 mr-2 flex items-center h-10">
          <button
        ...
        <div className="hidden sm:flex items-center gap-1.5">
          <div className="bg-orange-500/10 text-orange-700 px-3.5 py-1.5 rounded-full text-xs font-black uppercase tracking-wider flex items-center gap-1 border border-orange-500/10">
