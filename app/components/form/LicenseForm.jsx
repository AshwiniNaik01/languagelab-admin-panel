    ...
    <form onSubmit={handleSubmit} className="space-y-4 max-w-xl mx-auto bg-white p-6 rounded-2xl border border-orange-100 shadow-sm">
      ...
      <div>
        ...
        <select
          ...
          className={`w-full rounded-xl border text-amber-900  bg-white px-4 py-3 text-sm focus:outline-none ${errors.status
            ? "border-red-500 focus:border-red-500 focus:ring-2 focus:ring-red-200"
            : "border-orange-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-200"
            }`}
        >
          <option className="text-black-600" value="active">Active</option>
          <option className="text-black-600" value="expired">Expired</option>
          <option className="text-black-600" value="revoked">Revoked</option>
          <option className="text-black-600" value="suspended">Suspended</option>
        </select>
        {errors.status && (
